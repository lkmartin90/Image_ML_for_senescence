...
# This code reads in the drug discovery data for E31 and saves it in a much more managable and publishable format
...
drug_data_list = []
count = 0
for file in glob.glob("/mnt/CELL_PAINTING_DATA/LOPAC_raw_data/E31/E31*"):
    if count < 500:
        print(file)
...
drug_data_tot.to_csv("E31_LOPAC_data.csv")
