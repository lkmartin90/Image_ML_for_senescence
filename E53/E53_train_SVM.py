...
E_53_NucleiObject = pd.read_csv("../E53_LaminB1_P21_data/E53_220323_P21_LaminB1NucleiObject.csv")
E_53_NucleiObject = data_processing_Nuclei(E_53_NucleiObject)
E_53_DilatedNuclei = pd.read_csv("../E53_LaminB1_P21_data/E53_220323_P21_LaminB1DilatedNuclei_1.csv")
E_53_DilatedNuclei = data_processing_Dilated(E_53_DilatedNuclei)

# create one data object containing all the data
data = pd.concat([E_53_NucleiObject, E_53_DilatedNuclei], axis=1)
...
plot_ordered_classifier_score(results_df, "E53", "SVM")
# pickle

filename = 'E53_SVM_model.sav'
