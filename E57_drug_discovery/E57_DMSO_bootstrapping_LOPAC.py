...
drug_data_tot = pd.read_csv('E57_LOPAC_full_data.csv')
...
all_data = pd.read_csv("E57_senscore_LOPAC.csv")
...
all_data["conc"] = all_data["Metadata_platename"].map(
    {'E57L458-0-5': 0.5, 'E57L458-3': 3, 'E57L459-0-5': 0.5, 'E57L459-3': 3, 'E57L461-0-5': 0.5, 'E57L461-3': 3,
     'E57L460-0-5': 0.5, 'E57L460-3': 3, })
...
for plate in set(all_data["Metadata_platename"]):
    ...
    for well in set(drug_data_tot[(drug_data_tot["Metadata_platename"] == plate)]["Metadata_well"]):
        ...
        compound = list(
            drug_data_tot[(drug_data_tot["Metadata_platename"] == plate) & (drug_data_tot["Metadata_well"] == well)][
                "compound"])[0]
        ...
        if compound != "DMSO":
            ...
            num_cells_for_bootstrap = len(drug_data_tot[(drug_data_tot["Metadata_platename"] == plate) & (
                        drug_data_tot["Metadata_well"] == well)])
...
print(all_data)
all_data.to_csv("E57_LOPAC_with_bootstrap.csv")
